...
import scipy.misc
#sys.path.insert(0,'/nfs/zhengmeisong/wkspace/caffe/python/')
...
class Salicon:
    def __init__(self, prototxtpath='salicon_res18.prototxt', model='./train_output/res18_salicon_95849.caffemodel'):
